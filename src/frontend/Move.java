...
public static Shape shape;
    ...
    public Move(DrawingPanel drawingPanel,Shape shape) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("New position (x-axis):");

        jLabel2.setText("New position (y-axis):");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Move(drawingPanel,shape).setVisible(true);
            }
        });
    }
